...
import com.shuffle.otr4j.io.messages.AbstractEncodedMessage;
import com.shuffle.otr4j.io.messages.AbstractMessage;
import com.shuffle.otr4j.io.messages.DHCommitMessage;
import com.shuffle.otr4j.io.messages.DHKeyMessage;
import com.shuffle.otr4j.io.messages.DataMessage;
import com.shuffle.otr4j.io.messages.ErrorMessage;
import com.shuffle.otr4j.io.messages.MysteriousT;
import com.shuffle.otr4j.io.messages.PlainTextMessage;
import com.shuffle.otr4j.io.messages.QueryMessage;
import com.shuffle.otr4j.io.messages.RevealSignatureMessage;
import com.shuffle.otr4j.io.messages.SignatureM;
import com.shuffle.otr4j.io.messages.SignatureMessage;
import com.shuffle.otr4j.io.messages.SignatureX;
import com.shuffle.otr4j.session.Session;
			...
			case AbstractEncodedMessage.MESSAGE_DATA:
				...
				switch (m.messageType) {
					case AbstractEncodedMessage.MESSAGE_DHKEY:
						...
						if (dhkey.protocolVersion == Session.OTRv.THREE) {
					...
					case AbstractEncodedMessage.MESSAGE_REVEALSIG:
						...
						if (revealsig.protocolVersion == Session.OTRv.THREE) {
					...
					case AbstractEncodedMessage.MESSAGE_SIGNATURE:
						...
						if (sig.protocolVersion == Session.OTRv.THREE) {
					...
					case AbstractEncodedMessage.MESSAGE_DH_COMMIT:
						...
						if (dhcommit.protocolVersion == Session.OTRv.THREE) {
					...
					case AbstractEncodedMessage.MESSAGE_DATA:
						...
						if (data.protocolVersion == Session.OTRv.THREE) {

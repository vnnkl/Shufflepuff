...
public class BtcdQueryClient implements BtcdClient {
    ...
    public BtcdQueryClient(Properties nodeConfig) throws BitcoindException, CommunicationException {
        this(null, nodeConfig);
    }

    public BtcdQueryClient(CloseableHttpClient httpProvider, Properties nodeConfig)
    ...
    public BtcdQueryClient(String rpcUser, String rpcPassword) throws BitcoindException,
            CommunicationException {
        this(null, null, rpcUser, rpcPassword);
    }

    public BtcdQueryClient(CloseableHttpClient httpProvider, String rpcUser, String rpcPassword)
            throws BitcoindException, CommunicationException {
        this(httpProvider, null, null, rpcUser, rpcPassword);
    }

    public BtcdQueryClient(String rpcHost, Integer rpcPort, String rpcUser, String rpcPassword)
            throws BitcoindException, CommunicationException {
        this((String)null, rpcHost, rpcPort, rpcUser, rpcPassword);
    }

    public BtcdQueryClient(CloseableHttpClient httpProvider, String rpcHost, Integer rpcPort,
    ...
    public BtcdQueryClient(String rpcProtocol, String rpcHost, Integer rpcPort, String rpcUser,
    ...
    public BtcdQueryClient(CloseableHttpClient httpProvider, String rpcProtocol, String rpcHost,

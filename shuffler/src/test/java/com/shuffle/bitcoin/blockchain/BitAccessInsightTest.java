...
public class BitAccessInsightTest {
   ...
   BitAccessInsight BitAccessInsightTestnetTest = new BitAccessInsight(NetworkParameters.fromID(NetworkParameters.ID_TESTNET), 3);
   ...
   public void testGetAddressBalance() throws Exception {
      ...
      long balanceTest = BitAccessInsightTestnetTest.getAddressBalance("n2ooxjPCQ19f56ivrCBq93DM6a71TA89bc");
      ...
      long balance = BitAccessInsightTestnetTest.getAddressBalance("n2ooxjPCQ19f56ivrCBq93DM6a71TA89bc");
   ...
   public void testGetAddressTransactions() throws Exception {
      ...
      List<Bitcoin.Transaction> transactionListTest = BitAccessInsightTestnetTest.getAddressTransactions("n2ooxjPCQ19f56ivrCBq93DM6a71TA89bc");
      ...
      for (Bitcoin.Transaction trans : transactionListTest) {
         ...
         for (TransactionInput transInput : ta.getInputs()) {
            ...
            Transaction addressList = BitAccessInsightTestnetTest.getTransaction(parentHash);
   ...
   public void testGetTransaction() throws Exception {
      ...
      Transaction transactionTest = BitAccessInsightTestnetTest.getTransaction("a49aa30eb850966db6c1aba5c8c725cb375d9c741c597b462388dccee16408c3");

 ...
 */
public class BitAccessInsightTest {

   BitAccessInsight BitAccessInsightMainnetTest = new BitAccessInsight(NetworkParameters.fromID(NetworkParameters.ID_MAINNET), 3);
   ...
   public void testGetAddressBalance() throws Exception {
      ...
      long balanceTest = BitAccessInsightMainnetTest.getAddressBalance("1CL5zkcneQ1uHpK8f3zcTAnC1GbLdKo1vn");
      ...
      long balance = BitAccessInsightMainnetTest.getAddressBalance("1CL5zkcneQ1uHpK8f3zcTAnC1GbLdKo1vn");
   ...
   public void testGetAddressTransactions() throws Exception {
      ...
      List<Bitcoin.Transaction> transactionListTest = BitAccessInsightMainnetTest.getAddressTransactionsInner("n2ooxjPCQ19f56ivrCBq93DM6a71TA89bc");
      ...
      for (Bitcoin.Transaction trans : transactionListTest) {
         ...
         for (TransactionInput transInput : ta.getInputs()) {
            ...
            Transaction addressList = BitAccessInsightMainnetTest.getTransaction(parentHash);
   ...
   public void testGetTransaction() throws Exception {
      ...
      Transaction transactionTest = BitAccessInsightMainnetTest.getTransaction("a49aa30eb850966db6c1aba5c8c725cb375d9c741c597b462388dccee16408c3");

...
public class BlockCypherDotComTest {
   ...
   public void testGetAddressTransactions() throws Exception {
      ...
      TransactionHash txHashn = new TransactionHash("7045600275739fde7f3824c18dfda05801d6c22f3cc25fd98e361ed990c23ca4");
      List<com.shuffle.bitcoin.blockchain.Bitcoin.Transaction> transactionListTest = blockCypherTest.getAddressTransactions(txHashn, 0L);
      ...
      for (Bitcoin.Transaction trans : transactionListTest) {
         ...
         for (TransactionInput transInput : ta.getInputs()) {
            ...
            TransactionHash txHash = new TransactionHash(parentHash);
            Transaction addressList = blockCypherTest.getTransaction(txHash);
   ...
   public void testGetTransaction() throws Exception {
      ...
      TransactionHash txHash = new TransactionHash("a49aa30eb850966db6c1aba5c8c725cb375d9c741c597b462388dccee16408c3");
      Transaction transactionTest = blockCypherTest.getTransaction(txHash);

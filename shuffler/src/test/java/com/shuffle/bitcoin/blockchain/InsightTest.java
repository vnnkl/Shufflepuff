...
public class InsightTest {
   ...
   public void testGetAddressBalance() throws Exception {
      ...
      long balanceTest = insightTestnetTest.getAddressBalance("n2ooxjPCQ19f56ivrCBq93DM6a71TA89bc");
      ...
      long balance = insightTestnetTest.getAddressBalance("n2ooxjPCQ19f56ivrCBq93DM6a71TA89bc");
   ...
   public void testGetAddressTransactions() throws Exception {
      ...
      for (Bitcoin.Transaction trans : transactionListTest) {
         ...
         for (TransactionInput transInput : ta.getInputs()) {
            ...
            Transaction addressList = insightTestnetTest.getTransaction(parentHash);
